...
import {getCurrentApp} from '../../actions/applicationActions';
import {getCertForApp} from '../../actions/certificateActions';
import Moment from 'react-moment';

class Application extends Component {
    componentDidMount(){
        this.props.getCurrentApp(this.props.match.params.id);
        ...
        if(certificate._id){
            if(certificate.rejection){
                result = (
                    ...
                    <div className="col-md-12">
                        <span className="">
                           <div><p style={{color: 'red'}}><strong>Application Status : </strong>"Application Rejected"</p></div>
                ...
                <div className="row">
                    <div className="">
                        <span className="">
                        <Link className="btn btn-info" to={`/userCertificate/${application._id}`}>View Certificate</Link> 
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div className="row">
                    <div className="col-md-12">
                        <span className="">
                           <div><p style={{color: "#006B76"}}><strong>Application Status : </strong>"Not Reviewed"</p></div>
                        </span>
                    </div>
                </div>
            </div> 
...
Application.PropTypes = {
    getCurrentApp: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {getCurrentApp, getCertForApp})(Application);