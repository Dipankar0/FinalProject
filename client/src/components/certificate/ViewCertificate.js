        ...
        return(
            ...
            <div className="card card-body bg-light mb-3">
                ...
                <div className="row">
                    <div className="col-md-12">
                        <span className="">
                            <div><p><strong style={{color: '#4A90E2'}}>Product Company : </strong><strong style={{color: "#34A76E"}}>{certificate.companyName}</strong></p></div>
                        </span>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-12">
                        <span className="">
                            <div><p><strong style={{color: '#4A90E2'}}>Product Company Address : </strong><strong style={{color: "#34A76E"}}>{certificate.companyAdd}</strong></p></div>
                        </span>
                    </div>
                </div>
                <div className="row">
...
export default connect(mapStateToProps, {getCertForApp, getBlockProduct})(withRouter(ViewCertificate));