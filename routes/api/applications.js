...
(req, res) => {
  ...
  let ingriName, ingriCompany, ingriCompanyAdd, ingriStatus;
  if(req.body.ingreCert){
    console.log(req.body.ingreCert);
  Certificate.findById(req.body.ingreCert)
  .then(cert => {
    if(cert){
    ingriName = cert.productName;
    ingriCompany = cert.companyName;
    ingriCompanyAdd = cert.companyAdd;
    ingriStatus = "BlockChain Certified";
    }else{
      ...
      if (application) {
        ...
        const newApplication = {};
          ...
          if(req.body.ingreCert){
            ...
            newApplication.applicationStatus = ingriStatus;
          }else{
            newApplication.applicationStatus = "Not Blockchain Certified";
          }
